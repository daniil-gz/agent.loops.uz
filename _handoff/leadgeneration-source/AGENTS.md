...
## BioRise case — 2026-09-14
BioRise is second after ILVI; preserve preview → full case and link its existing project row. Use provided biorise.jpeg cover, preserve the whole portrait in preview/detail. Public figures are rounded Instagram-segment aggregates: approximately 950m UZS revenue, approximately 6 UZS revenue per 1 UZS ads, approximately 73% with repeat visits. Segment includes mixed Instagram sources, not an exclusively incremental paid-ad cohort. Owner confirms 4–6k monthly incoming requests, bot conducting first dialogue and administrators continuing with requests fitting clinic services. Do not conflate this monthly volume with the patient repeat-rate denominator or imply bot medical decisions. No new Meta or Klientiks export. Keep precise financial totals, underlying monthly table and methodology section out of public output.
